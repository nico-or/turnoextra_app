...
class Bgg::BoardgameMetadataUpdaterTest < ActiveSupport::TestCase
  ...
  test "update_boardgame_details" do
    bgg_boardgame = Bgg::Boardgame.new(**@bgg_boardgame_params)
  ...
  test "Should not create duplicated boardgame names" do
    ...
    new_bgg_boardgame_params = @bgg_boardgame_params.merge(titles: [ "New Game", "New Game", "Another Title", "Test Name" ])

    new_bgg_boardgame = Bgg::Boardgame.new(**new_bgg_boardgame_params)
